...
class TimeSpan(object):
    ...
    def total_hours(self, total_hours):
        ...
        if total_hours is None:
            raise ValueError("Invalid value for `total_hours`, must not be `None`")  # noqa: E501
    ...
    def total_milliseconds(self, total_milliseconds):
        ...
        if total_milliseconds is None:
            raise ValueError("Invalid value for `total_milliseconds`, must not be `None`")  # noqa: E501
    ...
    def total_minutes(self, total_minutes):
        ...
        if total_minutes is None:
            raise ValueError("Invalid value for `total_minutes`, must not be `None`")  # noqa: E501
